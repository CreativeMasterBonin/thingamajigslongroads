...
public class ActionCheckboxLongRoads extends AbstractWidget{
    ...
    private final ActionCheckboxLongRoads.OnValueChange onValueChange;
    private final MultiLineTextWidget textWidget;

    public ActionCheckboxLongRoads(int x, int y, int maxWidth, Component message, Font font, boolean selected){
        ...
        this.onValueChange = ActionCheckboxLongRoads::doAction;
    }
    ...
    public interface OnValueChange{
        ActionCheckboxLongRoads.OnValueChange NOP = ActionCheckboxLongRoads::doAction;
        void onValueChange(ActionCheckboxLongRoads var1, boolean var2);
    }
}
