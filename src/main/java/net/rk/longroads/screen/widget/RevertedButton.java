package net.rk.longroads.screen.widget;
...
// replaced ExtendedButtons with this custom class to hopefully fix rendering issues
...
public class RevertedButton extends ExtendedButton{
    ...
    public static final WidgetSprites LASER_SPRITES = new WidgetSprites(
            ResourceLocation.parse("thingamajigslongroads:container/generic/pressed_button"),
            ResourceLocation.parse("thingamajigslongroads:container/generic/disabled_button"),
            ResourceLocation.parse("thingamajigslongroads:container/generic/selected_button")
    );

    public static final WidgetSprites HC_BUTTON_SPRITES = new WidgetSprites(
            ResourceLocation.parse("thingamajigslongroads:container/generic/pressed_button_hc"),
            ResourceLocation.parse("thingamajigslongroads:container/generic/disabled_button_hc"),
            ResourceLocation.parse("thingamajigslongroads:container/generic/selected_button_hc")
    );
